...
<div class="container">
	<div class="col-md-12">
		<h1 style="font-family:algeria">Lista  de Categorias 
		<a href="{{route('categoria.create')}}" class="btn btn-success">
		<img src="https://cdn-icons-png.flaticon.com/512/32/32360.png" width="20px"> Nueva Categoria</a>
		</h1>
		...
		@foreach($categoria as $cat)
			<tr>
				...
				<td>
                    ...
                    <form action="{{route('categoria.destroy',$cat->cat_id)}}" method="POST" onsubmit="return confirm('Desea eliminar')">
                    	@csrf
